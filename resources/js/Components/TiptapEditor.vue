...
const editor = useEditor({
    ...
    extensions: [
        ...
        Placeholder.configure({
            placeholder: props.placeholder ?? 'Mulai menulis karya indahmu...',
        }),
...
function insertYoutube() {
    ...
    editor.value
        .chain()
        .focus()
        .setYoutubeVideo({ src: youtubeUrl.value })
        .run();
    youtubeUrl.value = '';
...
<template>
    <div
        class="tiptap-editor overflow-hidden rounded-xl"
        style="
    ...
    >
        ...
        >
            ...
            <div
                class="mx-1 h-5 w-px"
                style="background-color: var(--color-cream-300)"
            />
